...
>(({ className, variant, duration = 0, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={cn(toastVariants({ variant }), className)}
      duration={duration} // 0 = never auto-dismiss, user must manually close
      {...props}
    />
  );
});
